...
**Status: largely merged into v0.3.0.** The "model picker per
conversation" sub-item is the only v0.4 deliverable still pending,
and it is environment-level (Open WebUI config), not guasimo code.
